...
LoanType.create(id: 9, short_name: "Eterno", description: "prestamo al olvido 0 ganancia", payment_frequency_days: 365, is_profit_balane: true, number_of_payments: 1, profit_by_payment: 0.0, total_profit: 0.00e2, late_fee: 0.0e2, late_fee_profit: 0.0)
