class ExtraFeesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @extra_fee.save
        format.html { redirect_to @extra_fee, notice: 'Extra fee was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @extra_fee.update(extra_fee_params)
        format.html { redirect_to @extra_fee, notice: 'Extra fee was successfully updated.' }
  ...
  def destroy
    @extra_fee.destroy
    respond_to do |format|
      format.html { redirect_to extra_fees_url, notice: 'Extra fee was successfully destroyed.' }
