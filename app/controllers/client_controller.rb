class ClientController < ApplicationController
  ...
  before_action :set_client_loans, only: [:show, :send_invitation]
  ...
  def send_invitation
    ClientMailer.with(user: @client).send_invitation.deliver_later
    @notice = "Email enviado"
    render "show", locals:{notice: "Envaido satisfactoriamente"}
  end
