class MoneylendersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @moneylender.save
        format.html { redirect_to @moneylender, notice: 'Moneylender was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @moneylender.update(moneylender_params)
        format.html { redirect_to @moneylender, notice: 'Moneylender was successfully updated.' }
  ...
  def destroy
    @moneylender.destroy
    respond_to do |format|
      format.html { redirect_to moneylenders_url, notice: 'Moneylender was successfully destroyed.' }
